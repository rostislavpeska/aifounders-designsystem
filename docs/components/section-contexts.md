...
**Type:** system · **Status:** shipped · **git_path:** `assets/css/components.css#section-contexts` (scopes in `assets/css/tokens.css` layer 3) · **Specimen:** `/?aigds_styleguide=1&item=surfaces`
