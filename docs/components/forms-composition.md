...
**Type:** pattern · **Status:** shipped · **git_path:** `assets/css/components.css#forms` (sub-blocks: field scale, input pair) · **Specimen:** `/?aigds_styleguide=1&item=form-composition`
